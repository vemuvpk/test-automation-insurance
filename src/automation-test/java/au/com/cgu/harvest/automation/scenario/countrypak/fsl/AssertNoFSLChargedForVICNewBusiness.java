...
@Scenario( "Assert No FSL charged for VIC state New Business Scenario" )
public class AssertNoFSLChargedForVICNewBusiness
    extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new FinishPolicyAsNewPolicyActivity( personalIncomePage ) );
