...
@Scenario( "Complete An Amendment Transaction to Issue a Covernote and assert for status - Amendment Unclosed Accepted - Scenario" )
public class CompleteAnAmendmentTransactionToIssueCoverNoteScenario extends
    AbstractScenario
{
