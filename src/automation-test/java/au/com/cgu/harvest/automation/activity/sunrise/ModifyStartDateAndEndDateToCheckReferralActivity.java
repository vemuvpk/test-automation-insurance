...
@Activity( "Modify Start Date and End Date of Policy to Check Referrals in Policy Details Page" )
public class ModifyStartDateAndEndDateToCheckReferralActivity extends
    AbstractActivity< PolicyDetailPage >
{
    ...
    public ModifyStartDateAndEndDateToCheckReferralActivity( NewBusinessPage newBusinessPage,
        String startDate, String endDate, String referralRule )
    {
