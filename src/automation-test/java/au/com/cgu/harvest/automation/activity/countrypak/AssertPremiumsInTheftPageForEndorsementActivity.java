...
@Activity( "Assert Premium values in Theft Page in Endorsement Activity" )
public class AssertPremiumsInTheftPageForEndorsementActivity extends
    AbstractActivity< TheftPage >
{
    ...
    public AssertPremiumsInTheftPageForEndorsementActivity( HarvestPage page,
    ...
    protected TheftPage execute()
    {
        ...
        DodgyAssert.assertNearlyEquals( _sectionTotalPremium,
            theftPage.getSectionTotalTransactionBasePremiumValue() );
