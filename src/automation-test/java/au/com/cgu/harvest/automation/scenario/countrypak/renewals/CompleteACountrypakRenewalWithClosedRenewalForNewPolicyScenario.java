...
@Scenario( "Complete a Countrypak Renewal With Closed Renewal for New Policy Scenario" )
public class CompleteACountrypakRenewalWithClosedRenewalForNewPolicyScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new FinishPolicyAsClosedRenewalActivity( finishPage ) );
