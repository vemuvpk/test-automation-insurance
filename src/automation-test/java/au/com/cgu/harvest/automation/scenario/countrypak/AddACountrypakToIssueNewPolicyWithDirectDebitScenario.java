...
@Scenario( "Add a Countrypak and then Issue and accept a New Policy With Direct Debit Payment method scenario" )
public class AddACountrypakToIssueNewPolicyWithDirectDebitScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
