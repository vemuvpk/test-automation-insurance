...
@Scenario( "Add a Policy Check premium is not null and then Abort - to make sure you dont see any errors" )
public class AddACountrypakPolicyCheckPremiumAndAbortScenario
    extends
    AbstractScenario
{
    @Test
