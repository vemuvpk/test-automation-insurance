...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 9 - Personal Income Scenario" )
public class AssertManualPremiumRulesForCountrypakSection9Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
