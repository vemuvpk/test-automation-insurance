...
@Scenario( "Complete a Countrypak Renewal for New Policy Scenario" )
public class CompleteACountrypakRenewalWithRenewalInvitationForNewPolicyScenario extends
    AbstractScenario
{
