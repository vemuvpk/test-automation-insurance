...
@Scenario( "Introduce Policy Level Cover For Domestic Buildings and Assert that Excess and CoverType are not present Scenario" )
public class IntroducePolicyLevelCoverForDomesticBuildingsScenario extends AbstractScenario
{
    ...
    public void execute()
    {
        ...
        domesticBuildingAndContentsPage =
            performActivity( new AddSecondDomesticBuildingActivity( domesticBuildingAndContentsPage ) );
