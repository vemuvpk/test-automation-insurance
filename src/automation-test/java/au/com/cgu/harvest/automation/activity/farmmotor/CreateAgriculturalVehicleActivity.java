...
@Activity( "Create a Agricultural Motor Vehicle in a manner that allows a policy to be offered" )
public class CreateAgriculturalVehicleActivity extends AbstractActivity< AgriculturalVehiclePage >
{
    private HarvestPage _page;

    public CreateAgriculturalVehicleActivity( HarvestPage page )
    {
        _page = page;
    }
    ...
    protected AgriculturalVehiclePage execute()
    {
        ...
        vehicleDetailPage.setVehicleRatingDetails( "2866", "Molong", "NSW",
