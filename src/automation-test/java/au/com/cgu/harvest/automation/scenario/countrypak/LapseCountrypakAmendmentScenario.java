...
@Scenario( "Lapse a Amendment for Countrypak Scenario" )
public class LapseCountrypakAmendmentScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new AssertPolicyStateFromSunriseActivity( newBusinessPage,
                "Amendment Lapsed Complete" ) );

        newBusinessPage = performActivity( new GetAcceptanceActivity( newBusinessPage ) );
        newBusinessPage =
            performActivity( new AssertPolicyStateFromSunriseActivity( newBusinessPage,
                "Amendment Lapsed Accepted" ) );
