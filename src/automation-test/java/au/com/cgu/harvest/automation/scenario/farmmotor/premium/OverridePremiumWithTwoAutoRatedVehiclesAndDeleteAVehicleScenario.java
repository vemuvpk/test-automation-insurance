...
@Scenario( "Perform an override of the premium for two auto-rated vehicles and check for premium after deleting one vehicle" )
public class OverridePremiumWithTwoAutoRatedVehiclesAndDeleteAVehicleScenario extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        // VERIFY (9.2) - Verify premium is reset after deleting second vehicle
