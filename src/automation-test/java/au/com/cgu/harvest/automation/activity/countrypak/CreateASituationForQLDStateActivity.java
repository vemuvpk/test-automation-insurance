...
@Activity( "Create a Situation in Countrypak For QLD State Activity" )
public class CreateASituationForQLDStateActivity extends
    AbstractActivity< SituationDetailPage >
{
    private HarvestPage _page;

    public CreateASituationForQLDStateActivity( HarvestPage page )
    {
        _page = page;
    }
    ...
    protected SituationDetailPage execute()
    {
        ...
        createSituationLevelSectionPage.setSuburbStatePostcode( "Roma", "QLD", "4455" );
