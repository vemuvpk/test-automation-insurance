...
@Scenario( "Endorse an Endorsement Transaction for Countrypak Scenario" )
public class EndorseAnEndorsementTransactionForCountrypakScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        MachineryBreakdownPage machineryBreakdownPage =
            performActivity( new AddMachineryBreakdownActivity( policyDetailPage ) );
