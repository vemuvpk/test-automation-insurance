...
@Scenario( "Delete A Farm Motor vehicle as part of an Endorsement Scenario" )
public class DeleteVehicleAsPartOfAnFMEndorsementScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        verifyPremiumDecreasesAfterDeletingAVehicleForEndorsement( premiumPage );
        assertStrikeThroughForDeletedVehicleInPremiumSections( premiumPage );
    ...
    private void assertStrikeThroughForDeletedVehicleInPremiumSections( PremiumPage premiumPage )
    {
        premiumPage = performActivity( new ViewPremiumActivity( premiumPage ) );
        PremiumRow row = premiumPage.getPremiumGrid().getPremiumAtRow( 2 );
        Assert.assertTrue( row.isDeleted() );

    }

    private void verifyPremiumDecreasesAfterDeletingAVehicleForEndorsement( PremiumPage premiumPage )
    {
        PrivateMotorVehiclePage vehiclePage;
