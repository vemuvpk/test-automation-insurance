...
public class SaveTransactionAsNewPolicyWithCreditCardAndSetIntermediaryFeesActivity extends
    AbstractActivity< FinishPage >
{
    private FinishPage _page;

    public SaveTransactionAsNewPolicyWithCreditCardAndSetIntermediaryFeesActivity( FinishPage page )
    {
        _page = page;
    }
