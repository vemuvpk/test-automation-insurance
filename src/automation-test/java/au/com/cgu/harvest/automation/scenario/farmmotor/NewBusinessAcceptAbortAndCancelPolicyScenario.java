...
@Scenario( "Accept,Abort and cancel a New Business Policy with out accepting Scenario" )
public class NewBusinessAcceptAbortAndCancelPolicyScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new AbortActivity( agriculturalVehicle ) );
