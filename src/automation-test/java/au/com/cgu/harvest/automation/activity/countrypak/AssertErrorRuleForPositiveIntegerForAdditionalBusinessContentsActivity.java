...
public class AssertErrorRuleForPositiveIntegerForAdditionalBusinessContentsActivity extends
    AbstractActivity< DomesticBuildingAndContentsPage >
{
    private HarvestPage _page;

    public AssertErrorRuleForPositiveIntegerForAdditionalBusinessContentsActivity(
        HarvestPage page )
    {
        _page = page;
    }
    ...
    protected DomesticBuildingAndContentsPage execute()
    {
        ...
        domesticBuildingAndContentsPage.setAdditionalBusinessContentsSumInsured( "String" );
