...
@JiraReference( "CFMC-258, CFMC-375" )
@Scenario( "Assert a policy with Negative value in Amendment and Endorsement Transactions for Farmmotor Scenario" )
public class AssertPremiumWithNegativeValueForFarmmotorScenario extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        assertNegativePremiumInAmendmentTransaction( policyDetailPage, "100", "-15.0" );
        ...
        assertNegativePremiumInEndorsementTransaction( policyDetailPage, "50", "-10" );
