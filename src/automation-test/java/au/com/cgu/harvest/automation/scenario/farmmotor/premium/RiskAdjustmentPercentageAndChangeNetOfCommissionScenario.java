...
@Scenario( "To Check Risk Level Adj Percentage is retained at Risk Level After Changing Net Of Commission to YES for Auto Rated Vehicle" )
public class RiskAdjustmentPercentageAndChangeNetOfCommissionScenario
    extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        // VERIFY (55.1) - Apply Adjustment percentage at Risk level to the vehicle and check the
        ...
        Premium autoRatedVehiclePremum = premiumPage.getPremiumForRow( 1 );

        // VERIFY (55.2) - Change net of commission and check the values and chk Adj% is retained
        premiumPage.setNetOfCommission( "true" );

        Premium autoRatedVehiclPremiumAfterNetOfCommission = premiumPage.getPremiumForRow( 1 );

        PremiumAssert.assertTotalPremiumDecreased( autoRatedVehiclePremum,
            autoRatedVehiclPremiumAfterNetOfCommission );
