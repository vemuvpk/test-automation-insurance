...
@Scenario( "Assert State Can be changed in an Renewal Transaction for Countrypak Policy Scenario" )
public class AssertChangeStateForCountrypakRenewalScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
