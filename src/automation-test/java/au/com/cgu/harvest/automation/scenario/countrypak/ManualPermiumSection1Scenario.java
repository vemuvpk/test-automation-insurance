...
@Scenario( "Add a Countrypak With Section 1 with Manual Premium and then Issue and accept a policy scenario" )
public class ManualPermiumSection1Scenario extends AbstractScenario
{
    ...
    public void execute()
    {
        ...
        RoadTransitPage roadTransitPage =
            performActivity( new AddRoadTransitWithManualPremiumActivity(
