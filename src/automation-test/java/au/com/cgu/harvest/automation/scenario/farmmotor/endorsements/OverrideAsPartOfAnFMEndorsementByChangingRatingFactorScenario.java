...
@Scenario( "Verify Override is reset when Rating factor is changed in Endorsement Transaction Scenario" )
public class OverrideAsPartOfAnFMEndorsementByChangingRatingFactorScenario extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        verifyOverrideIsResetWhenRatingFactorChanged( premiumPage );
        premiumPage =
            performActivity( new GetCountOfRisksInTransactionPremiumActivity( premiumPage, 2 ) );
    }

    private void verifyOverrideIsResetWhenRatingFactorChanged( PremiumPage premiumPage )
    {
        PrivateMotorVehiclePage vehiclePage;
        ...
        vehiclePage = performActivity( new EditPrivateMotorVehicleActivity(
            premiumPage, 1 ) );
