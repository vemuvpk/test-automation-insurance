...
@Scenario( "Close An Endorsement With No Referral For Countrypak Policy Scenario" )
public class CloseAnEndorsementWithNoReferralForCountrypakPolicyScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
