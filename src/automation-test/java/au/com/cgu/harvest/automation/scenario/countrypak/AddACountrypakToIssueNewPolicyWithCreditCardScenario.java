...
@Scenario( "Add a Countrypak and then Issue and accept a New Policy With Credit Card Payment method scenario" )
public class AddACountrypakToIssueNewPolicyWithCreditCardScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
