...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 3 - Farm Machinery and Working Dogs Scenario" )
public class AssertManualPremiumRulesForCountrypakSection3Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
