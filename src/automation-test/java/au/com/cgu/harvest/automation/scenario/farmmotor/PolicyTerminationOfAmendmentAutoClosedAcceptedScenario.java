...
@Scenario( "Policy Termination of Amendment Auto Closed Accepted for Farm Motor Scenario" )
public class PolicyTerminationOfAmendmentAutoClosedAcceptedScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new AssertPolicyStateFromSunriseActivity( newBusinessPage,
                "Amendment Auto Closed Accepted" ) );
