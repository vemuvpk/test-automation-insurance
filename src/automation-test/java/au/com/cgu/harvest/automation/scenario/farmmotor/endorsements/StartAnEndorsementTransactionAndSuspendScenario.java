...
@Scenario( "Start An Endorsement Transaction And Suspend Scenario" )
public class StartAnEndorsementTransactionAndSuspendScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        vehiclePage.setVehicleDetails( "1111", "2866", "BLANK", "NSW" );
