...
@Activity( "Add Hay Fence and Live Stock Activity and check for rules E020 and R062" )
public class AddHayFenceLiveStockWithManualPremiumAndCheckRulesActivity extends
    AbstractActivity< HayFencesLiveStockPage >
{
    private HarvestPage _page;

    public AddHayFenceLiveStockWithManualPremiumAndCheckRulesActivity( HarvestPage page )
    {
        _page = page;
    }
