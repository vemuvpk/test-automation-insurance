...
@Scenario( "Add Comments to Countrypak Policy  and delete a section to check the comments are retained and attached at policy level scenario" )
public class AddCommentsToCountrypakPolicyScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        sections.add( "Situation - 1" );
        page =
            performActivity( new AddCommentActivity( farmMachineryPage, sections, "Second Comment",
                "Internal Comment", "Current Term" ) );
        domesticBuildingAndContentsPage =
