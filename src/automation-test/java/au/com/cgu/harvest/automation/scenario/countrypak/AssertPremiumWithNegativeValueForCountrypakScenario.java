...
@Scenario( "Assert a policy with Negative value in Amendment and Endorsement Transactions for Countrypak Scenario" )
public class AssertPremiumWithNegativeValueForCountrypakScenario extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        // Check Negative premium is not allowed in amendment transaction
        ...
        assertNegativePremiumNotAcceptedInTheTransaction( policyDetailPage, "100", "-15.0" );
        ...
        assertNegativePremiumAcceptedInTheTransaction( policyDetailPage, "50", "-10" );
    ...
    private void assertNegativePremiumNotAcceptedInTheTransaction(
        PolicyDetailPage policyDetailPage,
        String value, String premium )
    {
        String _value = value;
        ...
        wait.until( Rule.isDisplayed(
            By.xpath( domesticBuildingPage.ADDITIONAL_BUSINESS_CONTENTS_BASE_PREMIUM_LOCATOR ),
            "E010" ) );
        domesticBuildingPage.setAdditionalBusinessContentsBasePremium( "15.0" );
    }
