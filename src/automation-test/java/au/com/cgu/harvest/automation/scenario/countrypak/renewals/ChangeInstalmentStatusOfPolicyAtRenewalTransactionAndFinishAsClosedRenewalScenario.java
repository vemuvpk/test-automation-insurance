...
import au.com.cgu.harvest.automation.activity.FinishPolicyAsClosedRenewalWithReferralAndDirectDebitActivity;
...
@Scenario( "Change Instalment Status of a Policy at Renewal Transaction For Countrypak Policy And Finish as Closed Renewal Scenario" )
public class ChangeInstalmentStatusOfPolicyAtRenewalTransactionAndFinishAsClosedRenewalScenario
    extends
    AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        finishPage =
            performActivity( new FinishPolicyAsClosedRenewalWithReferralAndDirectDebitActivity(
                finishPage ) );
        newBusinessPage = performActivity( new SuspendActivity( finishPage ) );

        newBusinessPage =
            performActivity( new AssertPolicyStateFromSunriseActivity( newBusinessPage,
                "Amendment Auto Closed Incomplete" ) );
        ...
        newBusinessPage =
            performActivity( new AssertPolicyStateFromSunriseActivity( newBusinessPage,
                "Amendment Auto Closed Complete" ) );
