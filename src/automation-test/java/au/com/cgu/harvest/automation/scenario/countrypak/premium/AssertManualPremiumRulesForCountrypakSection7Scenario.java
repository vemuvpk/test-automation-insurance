...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 7 - Business Liability Scenario" )
public class AssertManualPremiumRulesForCountrypakSection7Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
