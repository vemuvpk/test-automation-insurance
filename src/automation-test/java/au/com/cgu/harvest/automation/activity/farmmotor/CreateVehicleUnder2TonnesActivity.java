...
@Activity( "Create a Vehicle Under 2 Tonnes in a manner that allows a policy to be offered" )
public class CreateVehicleUnder2TonnesActivity extends AbstractActivity< VehicleUnder2TonnesPage >
{
    private HarvestPage _page;

    public CreateVehicleUnder2TonnesActivity( HarvestPage page )
    {
        _page = page;
    }
    ...
    protected VehicleUnder2TonnesPage execute()
    {
        ...
        vehicleDetailPage.setVehicleRatingDetails( "2866", "Molong", "NSW", "$99,300" );
        vehicleDetailPage.setComprehensiveCover( "true", "3 years" );
