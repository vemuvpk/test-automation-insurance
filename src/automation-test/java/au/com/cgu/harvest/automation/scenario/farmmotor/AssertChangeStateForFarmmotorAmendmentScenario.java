...
@Scenario( "Assert State Cannot be changed in an Amendment Transaction for Farmmotor Policy Scenario" )
public class AssertChangeStateForFarmmotorAmendmentScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
