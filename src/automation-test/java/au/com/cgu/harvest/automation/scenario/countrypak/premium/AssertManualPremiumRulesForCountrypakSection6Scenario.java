...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 6 - Business Interruption Scenario" )
public class AssertManualPremiumRulesForCountrypakSection6Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
