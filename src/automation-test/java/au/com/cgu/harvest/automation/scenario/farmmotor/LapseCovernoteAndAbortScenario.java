...
@Scenario( "Lapse a Covernote Scenario" )
public class LapseCovernoteAndAbortScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        terminateActivity( newBusinessPage );

        newBusinessPage = performActivity( new AbortActivity( policyDetailPage ) );

    }

    private void terminateActivity( NewBusinessPage newBusinessPage )
    {
        newBusinessPage.terminate();
        newBusinessPage.terminateRiskDetails();
    }
}
