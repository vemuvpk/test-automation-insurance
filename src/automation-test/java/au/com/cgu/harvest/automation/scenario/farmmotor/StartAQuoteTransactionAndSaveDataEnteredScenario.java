...
@Scenario( "Start A Quote Transaction And Save Data Entered for Farm Motor Scenario" )
public class StartAQuoteTransactionAndSaveDataEnteredScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
