...
@Scenario( "Delete an In Progress Transaction and assert that No errors are found on the page" )
public class DeleteAnInProgressTransactionScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
