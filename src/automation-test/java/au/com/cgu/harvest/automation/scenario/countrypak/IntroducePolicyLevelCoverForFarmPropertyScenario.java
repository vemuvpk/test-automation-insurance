...
@Scenario( "Introduce Policy Level Cover For Farm Property and Assert that Excess and CoverType are not present Scenario" )
public class IntroducePolicyLevelCoverForFarmPropertyScenario extends AbstractScenario
{
    ...
    public void execute()
    {
        ...
        farmPropertyPage =
            performActivity( new AddSecondFarmPropertyActivity( farmPropertyPage ) );
