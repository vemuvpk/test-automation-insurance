...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 2 Scenario" )
public class AssertManualPremiumRulesForCountrypakSection2Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
