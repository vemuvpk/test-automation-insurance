...
@Scenario( "Complete an Endorsement Transaction with Referral for Countrypak Scenario" )
public class CompleteAnEndorsementTransactionWithReferralForCountrypakScenario extends
    AbstractScenario
{
