...
import au.com.cgu.harvest.automation.activity.farmmotor.FinishPolicyAsEndorsementPolicyWithMonthlyDirectDebitActivity;
...
@Scenario( "Endorse an Instalment Policy and change Payment method in the endorsement transaction for Countrypak Scenario" )
public class EndorseAnInstalmentPolicyAndChangePaymentMethodForCountrypakScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new FinishPolicyAsEndorsementPolicyWithMonthlyDirectDebitActivity(
                finishPage ) );
        newBusinessPage =
            performActivity( new GetAcceptanceActivity( newBusinessPage ) );
        ...
        policyDetailPage =
            performActivity( new AssertPolicyStageAndStatusInHeaderActivity( policyDetailPage,
                "Endorsement", "Complete", "Monthly Direct Debit" ) );
