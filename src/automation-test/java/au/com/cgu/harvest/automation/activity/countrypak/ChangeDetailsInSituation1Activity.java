...
public class ChangeDetailsInSituation1Activity extends
    AbstractActivity< SituationDetailPage >
{
    private HarvestPage _page;

    public ChangeDetailsInSituation1Activity( HarvestPage page )
    {
        _page = page;
    }
    ...
    protected SituationDetailPage execute()
    {
        ...
        addSituation.setAddressLine1( "Situation-1" );
