...
@JiraReference( "PH-126" )
@Scenario( "Policy Termination of Renewal Auto Closed Accepted for Countrypak Scenario" )
    ...
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        finishPage.finishWithReferral();
        newBusinessPage =
            performActivity( new AddAuthorisationCodeAndFinishActivity( finishPage ) );
