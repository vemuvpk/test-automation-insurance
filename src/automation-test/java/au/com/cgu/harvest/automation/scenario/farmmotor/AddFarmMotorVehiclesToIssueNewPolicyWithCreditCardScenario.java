...
@Scenario( "Issue a Farm Motor New Policy With Credit Card Payment method scenario" )
public class AddFarmMotorVehiclesToIssueNewPolicyWithCreditCardScenario extends AbstractScenario
{
