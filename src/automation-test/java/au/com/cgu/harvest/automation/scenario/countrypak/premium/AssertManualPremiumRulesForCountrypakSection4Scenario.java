...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 4 - Theft Scenario" )
public class AssertManualPremiumRulesForCountrypakSection4Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
