...
@Activity( "Create a private motor vehicle with no windscreen extension in a manner that allows a policy to be completed" )
public class CreatePrivateMotorVehicleWithNoWindscreenExtensionActivity extends
    AbstractActivity< PrivateMotorVehiclePage >
{
    private HarvestPage _page;

    public CreatePrivateMotorVehicleWithNoWindscreenExtensionActivity( HarvestPage page )
    {
        _page = page;
    }
    ...
    protected PrivateMotorVehiclePage execute()
    {
        ...
        vehicleDetailPage.selectComprehensiveCover( "false", "2 years" );
