...
@Scenario( "Assert Manual Premium Rules For Countrypak Section 8 - Machinery Breakdown Scenario" )
public class AssertManualPremiumRulesForCountrypakSection8Scenario extends AbstractScenario
{
    @Test
    public void execute()
    {
