...
@Scenario( "Complete An Amendment Transaction to Issue a New Policy and assert for status - Amendment Auto Closed Accepted - Scenario" )
public class CompleteAnAmendmentTransactionToIssueNewPolicyScenario extends
    AbstractScenario
{
    ...
    public void execute()
    {
        ...
        newBusinessPage =
            performActivity( new FinishPolicyAsNewPolicyActivity( insuranceHistoryPage ) );
