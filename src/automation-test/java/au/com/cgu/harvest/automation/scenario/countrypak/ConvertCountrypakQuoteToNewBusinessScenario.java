...
@Scenario( "Convert Quote to New Business Transaction For a Countrypak Scenario" )
public class ConvertCountrypakQuoteToNewBusinessScenario extends AbstractScenario
{
    @Test
    public void execute()
    {
        ...
        NewBusinessPage newBusinessPage =
            performActivity( new SuspendActivity( domesticBuildingspage ) );
