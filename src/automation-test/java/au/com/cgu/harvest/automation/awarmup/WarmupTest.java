package au.com.cgu.harvest.automation.awarmup;
...
@Scenario( "This is a test to warm up the server and to make sure all the components are up and running." )
public class WarmupTest extends AbstractScenario
{
    @Test
    public void execute()
    {
